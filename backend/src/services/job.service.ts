...
export class JobService {
  ...
  async createJob(userId: string, userRole: UserRole, dto: CreateJobDto): Promise<IJob> {
...
async updateJob(userId: string, userRole: UserRole,jobId: string,dto: UpdateJobDto): Promise<IJob> {
