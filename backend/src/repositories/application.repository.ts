...
export class ApplicationRepository implements IApplicationRepository{
    ...
    async updateStatus(id:string,status:ApplicationStatus,notes?:string):Promise<IApplication|null>{
        return await Application.findByIdAndUpdate(id,{status,notes},{new:true})
    }
}